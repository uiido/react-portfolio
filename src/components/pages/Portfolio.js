    ...
    return (
        <div class="container p-3 mt-3">
            ...
            <Row>
                ...
                <Col xs={12} md={6} lg={4}>
                    <a href="https://saidou25.github.io/Print-or-Film/" target="_"><img src='https://mdbootstrap.com/img/new/slides/041.webp' className='img-fluid rounded' alt='Print or Film?' /></a>
                    <h2>Print Or Film</h2>
                ...
                <Col xs={12} md={6} lg={4}>
                    <a href="https://calm-tundra-31787.herokuapp.com/" target="_"><img src='https://mdbootstrap.com/img/new/slides/041.webp' className='img-fluid rounded' alt='Tech Blog' /></a>
                    <h2>Tech Blog</h2>
                ...
                <Col xs={12} md={6} lg={4}>
                    <a href="https://www.youtube.com/watch?v=A56FILRK6V4&ab_channel=Uiido" target="_"><img src='https://mdbootstrap.com/img/new/slides/041.webp' className='img-fluid rounded' alt='E-Commerce Back-end' /></a>
                ...
                <Col xs={12} md={6} lg={4}>
                    <a href="https://github.com/uiido/team-profile-generator/raw/main/assets/Video-Demonstration.gif" target="_"><img src='https://mdbootstrap.com/img/new/slides/041.webp' className='img-fluid rounded' alt='Team Profile Generator' /></a>
                ...
                <Col xs={12} md={6} lg={4}>
                    <a href="https://youtu.be/3BrFelvw1Cs" target="_"><img src='https://mdbootstrap.com/img/new/slides/041.webp' className='img-fluid rounded' alt='Social Network API' /></a>
